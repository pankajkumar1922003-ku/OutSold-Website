...
const PlatformStatistics = () => {
    return (
        <section
            id="statistics"
            className="relative overflow-hidden bg-[#EEF1F3] py-16 sm:py-24"
        >
            {/* ================= BACKGROUND DECORATIONS ================= */}

            <div className="pointer-events-none absolute -left-40 top-10 h-[450px] w-[450px] rounded-full bg-[#007A78]/10 blur-[150px]" />

            <div className="pointer-events-none absolute -right-40 bottom-0 h-[450px] w-[450px] rounded-full bg-[#20B2AA]/10 blur-[150px]" />
            ...
            <div className="relative z-10 mx-auto flex min-h-[520px] max-w-7xl items-center justify-center px-5 sm:px-8 lg:px-10">
                ...
                >
                    ...
                    >
                        We&apos;re just getting started. As OutSold grows,
                        we&apos;ll share the milestones, experiences and
                        achievements that make our journey special.
                    </motion.p>
