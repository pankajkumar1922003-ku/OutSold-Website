...
const statistics = [
    {
        ...
        description: "Events successfully managed on our platform.",
    },
    {
        icon: Ticket,
        value: "500K+",
        label: "Tickets Sold",
        description: "Tickets booked for unforgettable experiences.",
    },
    {
        icon: Users,
        value: "250K+",
        label: "Happy Attendees",
        description: "People connected through amazing events.",
    },
    {
        icon: IndianRupee,
        value: "₹10Cr+",
        label: "Revenue Generated",
        description: "Revenue generated by event organizers.",
    },
];
                    ...
                    {statistics.map((stat, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group relative overflow-hidden rounded-3xl border border-[#007A78]/10 bg-white p-7 shadow-lg shadow-[#007A78]/5 transition hover:border-[#007A78]/25 hover:shadow-xl"
                            >
                                {/* Hover Glow */}
                                ...
                                <motion.h3
                                    ...
                                    className="relative mt-7 text-4xl font-bold tracking-tight text-[#16302E]"
                                >
                                    {stat.value}
                                </motion.h3>

                                {/* Label */}
                                <h4 className="relative mt-2 text-lg font-semibold text-[#007A78]">
                                    {stat.label}
                                </h4>

                                {/* Description */}
                                <p className="relative mt-3 text-sm leading-6 text-[#16302E]/55">
                                    {stat.description}
                                </p>

                                {/* Bottom Line */}
                                <div className="relative mt-6 h-px w-full bg-gradient-to-r from-[#007A78]/25 to-transparent" />
                            </motion.div>
                        );
                    })}
                </div>
